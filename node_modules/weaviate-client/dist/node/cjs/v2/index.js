...
const index_js_2 = __importDefault(require('../graphql/index.js'));
const index_js_3 = __importDefault(require('../schema/index.js'));
const index_js_4 = __importDefault(require('../data/index.js'));
const index_js_5 = __importDefault(require('../classifications/index.js'));
const index_js_6 = __importDefault(require('../batch/index.js'));
const index_js_7 = __importDefault(require('../misc/index.js'));
const index_js_8 = __importDefault(require('../c11y/index.js'));
const dbVersion_js_1 = require('../utils/dbVersion.js');
const index_js_9 = __importDefault(require('../backup/index.js'));
const index_js_10 = __importDefault(require('../cluster/index.js'));
...
const app = {
  client: function (params) {
    ...
    const conn = new index_js_1.ConnectionGQL(params);
    ...
    const ifc = {
      graphql: (0, index_js_2.default)(conn),
      schema: (0, index_js_3.default)(conn),
      data: (0, index_js_4.default)(conn, dbVersionSupport),
      classifications: (0, index_js_5.default)(conn),
      batch: (0, index_js_6.default)(conn, dbVersionSupport),
      misc: (0, index_js_7.default)(conn, dbVersionProvider),
      c11y: (0, index_js_8.default)(conn),
      backup: (0, index_js_9.default)(conn),
      cluster: (0, index_js_10.default)(conn),
    };
