...
const index_js_3 = __importDefault(require('./collections/index.js'));
const index_js_4 = require('./collections/config/index.js');
const index_js_5 = require('./collections/configure/index.js');
...
const app = {
  ...
  connectToWCD: function (clusterURL, options) {
    return (0, helpers_js_1.connectToWCD)(clusterURL, this.client, options);
  },
  client: function (params) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const { connection, dbVersionProvider, dbVersionSupport } = yield index_js_1.ConnectionGRPC.use({
      ...
      const ifc = {
        ...
        cluster: (0, index_js_2.default)(connection),
        collections: (0, index_js_3.default)(connection, dbVersionSupport),
  ...
  configure: index_js_5.configure,
  configGuards: index_js_4.configGuards,
  reconfigure: index_js_5.reconfigure,
};
exports.default = app;
