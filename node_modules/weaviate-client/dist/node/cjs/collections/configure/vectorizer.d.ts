...
export declare const vectorizer: {
  ...
  text2VecGPT4All: <T_4, N_10 extends string | undefined = undefined, I_10 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_4>, N_10, I_10, 'text2vec-gpt4all'>;
  /**
  ...
  text2VecHuggingFace: <T_5, N_11 extends string | undefined = undefined, I_11 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_5>, N_11, I_11, 'text2vec-huggingface'>;
  /**
  ...
  text2VecJina: <T_6, N_12 extends string | undefined = undefined, I_12 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_6>, N_12, I_12, 'text2vec-jina'>;
  /**
  ...
  text2VecOpenAI: <T_7, N_13 extends string | undefined = undefined, I_13 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_7>, N_13, I_13, 'text2vec-openai'>;
  /**
  ...
  text2VecPalm: <T_8, N_14 extends string | undefined = undefined, I_14 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_8>, N_14, I_14, 'text2vec-palm'>;
  /**
  ...
  text2VecTransformers: <T_9, N_15 extends string | undefined = undefined, I_15 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_9>, N_15, I_15, 'text2vec-transformers'>;
  /**
  ...
  text2VecVoyageAI: <T_10, N_16 extends string | undefined = undefined, I_16 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_10>, N_16, I_16, 'text2vec-voyageai'>;
};
