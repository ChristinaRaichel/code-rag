...
const index_js_1 = __importDefault(require('./collection/index.js'));
...
const collections = (connection, dbVersionSupport) => {
  const listAll = () =>
    new index_js_2.SchemaGetter(connection)
      .do()
      .then((schema) => (schema.classes ? schema.classes.map(utils_js_1.classToCollection) : []));
  const deleteCollection = (name) => new index_js_2.ClassDeleter(connection).withClassName(name).do();
  return {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const makeVectorsConfig = (configVectorizers) => {
          ...
          const vectorizersConfig = Array.isArray(configVectorizers)
            ? configVectorizers
            : [Object.assign(Object.assign({}, configVectorizers), { vectorName: 'default' })];
        ...
        yield new index_js_2.ClassCreator(connection).withClass(schema).do();
        return (0, index_js_1.default)(connection, name, dbVersionSupport);
      });
    },
    createFromSchema: function (config) {
      return __awaiter(this, void 0, void 0, function* () {
        const { class: name } = yield new index_js_2.ClassCreator(connection).withClass(config).do();
        return (0, index_js_1.default)(connection, name, dbVersionSupport);
      });
    },
    ...
    export: (name) =>
      new index_js_2.ClassGetter(connection).withClassName(name).do().then(utils_js_1.classToCollection),
    listAll: listAll,
    get: (name) => (0, index_js_1.default)(connection, name, dbVersionSupport),
  };
};
