  ...
  const parseObject = (object) => {
    ...
    const obj = {
      ...
      properties: object.properties
        ? index_js_2.Serialize.restProperties(object.properties, object.references)
        : undefined,
    };
  ...
  return {
    ...
    deleteMany: (where, opts) =>
      connection
        ...
        .then((batch) =>
          batch.withDelete({
            filters: index_js_2.Serialize.filtersGRPC(where),
            dryRun: opts === null || opts === void 0 ? void 0 : opts.dryRun,
            verbose: opts === null || opts === void 0 ? void 0 : opts.verbose,
          })
        )
        .then((reply) =>
          index_js_3.Deserialize.deleteMany(reply, opts === null || opts === void 0 ? void 0 : opts.verbose)
        ),
    exists: (id) =>
      addContext(
        ...
        .then((path) =>
          connection.postReturn(
            ...
            Object.assign(
              ...
              parseObject(obj ? (index_js_2.DataGuards.isDataObject(obj) ? obj : { properties: obj }) : obj)
            )
          )
        )
        .then((obj) => obj.id),
    insertMany: (objects) =>
      connection.batch(name, consistencyLevel).then((batch) =>
        __awaiter(void 0, void 0, void 0, function* () {
          const serialized = yield index_js_2.Serialize.batchObjects(name, objects, tenant);
          const start = Date.now();
          const reply = yield batch.withObjects({ objects: serialized.mapped });
          const end = Date.now();
          return index_js_3.Deserialize.batchObjects(reply, serialized.batch, serialized.mapped, end - start);
        })
      ),
    referenceAdd: (args) =>
      referencesPath
