  ...
  vectorIndex: {
    ...
    quantizer: {
      bq: (
        ...
        cache: import('./types/base.js').RecursivePartial<boolean> | undefined;
        rescoreLimit: number | undefined;
        type: 'bq';
      };
      pq: (
        ...
        bitCompression: import('./types/base.js').RecursivePartial<boolean> | undefined;
        centroids: number | undefined;
        encoder:
          | import('./types/base.js').RecursivePartial<import('../types/index.js').PQEncoderConfig>
          | undefined;
        segments: number | undefined;
        trainingLimit: number | undefined;
        type: 'pq';
